...
//$fhirRegisterURL = AuthorizationController::getAuthBaseFullURL() . AuthorizationController::getRegistrationPath(); #maybe wrong
$fhirRegisterURL = rtrim(AuthorizationController::getAuthBaseFullURL(), '/') . '/' . ltrim(AuthorizationController::getRegistrationPath(), '/');
